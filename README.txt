...
a persistence unit "ExamenVeletangaVinicioServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenVeletangaVinicioServidor\pom.xml":
...
artifact ("ExamenVeletangaVinicioServidor.war") is already built. You can build
